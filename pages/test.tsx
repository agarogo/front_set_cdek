...
const TestPage: NextPage<TestPageProps> = ({ currentUser }) => {
  ...
  const handleExtraSubmit = async (skip: boolean) => {
    ...
    try {
      ...
      console.error(e);
      // даже если не сохранилось, отправляем на главную
    } finally {
      setSaving(false);
      router.push("/dashboard");
    }
            ...
            {!showExtra ? (
              <div className="flex flex-col md:flex-row gap-3 justify-between">
                <button
                  ...
                  className="px-6 py-3 rounded-full bg-[#00B33C] text-white text-sm font-semibold hover:bg-[#00A334] transition"
                  disabled={saving}
                >
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex flex-col md:flex-row gap-3 justify-end mt-4">
                  <button
                    ...
                    className="px-6 py-3 rounded-full bg-[#00B33C] text-white text-sm font-semibold hover:bg-[#00A334] transition disabled:bg-gray-300"
                    disabled={saving}
                  >
          ...
          <>
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="flex-1 ml-4 h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
                  className="h-full bg-[#00B33C] transition-all"
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      selected
                        ? "bg-[#00B33C] border-[#00B33C] text-white"
